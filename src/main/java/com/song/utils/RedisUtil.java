...
public final class RedisUtil {
     ...
     * 将key存入redis bitmap
     */
    public boolean isExist(final String where, String key,final long[] indexs) {
        final RedisSerializer<String> serializer = redisTemplate.getStringSerializer();

        List<Object> bitmaps =redisTemplate.executePipelined(new RedisCallback<Boolean>() {
            @Override
        ...
        return !bitmaps.contains(false);
    }

    /**
     * 将key存入redis bitmap
     */
    public void setBit(final String where, String key,final long[] indexs) {
        final RedisSerializer<String> serializer = redisTemplate.getStringSerializer();

        List<Object> bitmaps = redisTemplate.executePipelined(new RedisCallback<String>() {
            @Override
