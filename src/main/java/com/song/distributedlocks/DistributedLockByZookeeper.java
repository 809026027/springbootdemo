...
public class DistributedLockByZookeeper implements InitializingBean{
     ...
     * log
     */
    private static final Logger logger = LoggerFactory.getLogger(DistributedLockByZookeeper.class);

    private final static String ROOT_PATH_LOCK = "feng";
        ...
        try {
            ...
            cache.getListenable().addListener((client, event) -> {
                if (event.getType().equals(PathChildrenCacheEvent.Type.CHILD_REMOVED)) {
                    ...
                    logger.info("上一个节点 " + oldPath + " 已经被断开");
